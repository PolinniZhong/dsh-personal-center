...
- **双皮肤**:面板可切换 **圆滚滚小黑鲸(黑鲸)** / **圆滚滚小蓝鲸(蓝鲸,呼应 DeepSeek 蓝色品牌)**,即时生效、各自独立素材;
...
- **右键**快捷菜单:隐藏宠物;
- 「宠物」tab 极简面板:单卡片 = 预览 + 标题(悬停 ⓘ 弹使用提示)+ 今日统计 + **皮肤选择(黑鲸/蓝鲸)** + **不透明度档位(30%/60%/100%)** + 右侧**今日情绪气泡** + **启用开关**(点开使用/关闭即隐藏,无重复按钮);
