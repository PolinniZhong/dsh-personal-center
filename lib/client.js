...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			".dsh-pc-pill-tabs{display:inline-flex;gap:4px}" +
			".dsh-pc-pill-tab{border:0;background:0 0;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;font-size:13px;line-height:16px;padding:2px 6px;border-radius:999px}" +
			...
			".dsh-pc-cost-model + .dsh-pc-cost-model{margin-top:24px}" +
			...
			".dsh-pc-cost-key{font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:12px;line-height:18px;color:var(--dsw-alias-label-primary);min-width:0;flex:1;word-break:break-all}" +
