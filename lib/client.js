...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			".dsh-inst-subtabs{display:flex;gap:2px;margin:12px 0 2px}" +
			...
			".dsh-inst-section[data-active=true]{display:block;margin-top:12px}" +
			".dsh-inst-desc{color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px;margin:6px 0 10px}" +
			...
			".dsh-inst-ws-path{font-size:12.5px;font-weight:600;color:var(--dsw-alias-label-primary);min-width:0;flex:1;word-break:break-all;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}" +
			...
			".dsh-inst-tpl-actions{display:flex;gap:6px;margin-top:2px}" +
			...
			return react.createElement("div", { className: "dsh-pc-panel" },
				...
				react.createElement("div", { className: "dsh-inst-section", "data-active": sub === "global" },
					react.createElement("div", { className: "dsh-ci-header" },
						react.createElement("h2", { className: "dsh-ci-title" }, t("ciSubGlobal")),
				...
				react.createElement("div", { className: "dsh-inst-section", "data-active": sub === "ws" },
					react.createElement("div", { className: "dsh-ci-header" },
						react.createElement("h2", { className: "dsh-ci-title" }, t("ciSubWs")),
						react.createElement("div", { className: "dsh-ci-actions" }, wsSaving && react.createElement("span", { className: "dsh-inst-saved show" }, t("saved")))
					),
								...
								wsKeys.map((key) => {
									...
									return react.createElement("div", { key, className: "dsh-inst-ws-item", "data-current": isCurrent },
										react.createElement("div", { className: "dsh-inst-ws-head" },
											react.createElement("span", { className: "dsh-inst-ws-path", title: key }, key),
				...
				react.createElement("div", { className: "dsh-inst-section", "data-active": sub === "tpl" },
					react.createElement("div", { className: "dsh-ci-header" },
						react.createElement("h2", { className: "dsh-ci-title" }, t("ciSubTpl")),
						react.createElement("div", { className: "dsh-ci-actions" }, tplSaved && react.createElement("span", { className: "dsh-inst-saved show" }, t("saved")))
					),
