...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/**
		 * 情绪阈值(占位值,源自 PRD/交接文档;P0-3 按本机真实数据校准后另行提交)。
		 */
		const PET_THRESHOLDS = {
			happy_cache_rate: 0.7,
			busy_tool_calls: 50,
			exhausted_tokens: 100000,
			money_pain_cost: 5,
			dozing_idle_minutes: 10
		};
