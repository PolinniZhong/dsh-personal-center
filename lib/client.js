...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			".dsh-inst-ws-expand{border:0;background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary);cursor:pointer;font-family:inherit;font-size:11px;line-height:16px;padding:0 8px;border-radius:8px;flex:none}" +
			".dsh-inst-ws-expand:hover{background:var(--dsw-alias-interactive-bg-active);color:var(--dsw-alias-label-primary)}" +
			".dsh-inst-ws-tag{font-size:10.5px;padding:1px 8px;border-radius:9px;background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-tertiary);white-space:nowrap}" +
			".dsh-inst-ws-tag[data-current=true]{background:#eef1ff;color:var(--dsw-alias-state-business-primary)}" +
			".dsh-inst-ws-tag[data-configured=true]{background:var(--dsw-alias-state-success-secondary);color:var(--dsw-alias-state-success-primary)}" +
			...
			".dsh-inst-ws-caret{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);cursor:pointer;border-radius:8px;height:28px;width:30px;font-size:13px;line-height:1;flex:none}" +
			...
			return react.createElement("div", { className: "dsh-pc-panel" },
				...
				react.createElement("div", { className: "dsh-inst-section", "data-active": sub === "ws" },
								...
								wsKeys.map((key) => {
									...
									return react.createElement("div", { key, className: "dsh-inst-ws-item", "data-current": isCurrent },
										react.createElement("div", { className: "dsh-inst-ws-head" },
											...
											btn("dsh-inst-ws-expand", expanded ? "—" : "…", togglePath),
					...
					react.createElement("div", { className: "dsh-inst-ws-picker" },
						...
						btn("dsh-inst-ws-caret", "⌄", () => setWsOpen(!wsOpen)),
					...
					// 注入预览(模板库上方;默认显示全局指令,工作区指令折叠)
					react.createElement("div", { className: "dsh-inst-preview" },
						react.createElement("div", { className: "dsh-inst-preview-title" },
							react.createElement("span", null,
								t("ciPreviewTitle").replace("{{ws}}", currentWs ? currentWs.split("/").pop() : "—"),
								" ",
								react.createElement("b", null, currentWsKey ? t("ciSourceWs") : t("ciSourceGlobal"))
							),
						...
						currentWsText && react.createElement("div", null,
							btn("dsh-inst-preview-toggle", openWs ? t("ciWsToggleOpen") : t("ciWsToggle"), () => setOpenWs(!openWs)),
							openWs && react.createElement("div", { className: "dsh-inst-preview-global" }, currentWsText)
						)
					),
