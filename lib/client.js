...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			".dsh-pc-cost-row + .dsh-pc-cost-row{margin-top:24px}" +
		...
		/**
		 * 「个人资料」tab:子 tab(概览/活动/模型/会话/成本)拆分长页面。
		...
		function ProfileTab({ t }) {
			...
			const block = sub === "overview" ? react.createElement("div", { className: "dsh-pc-panel" },
				...
				: sub === "activity" ? react.createElement("div", { className: "dsh-pc-panel" },
					react.createElement(TokenActivity, { t, weeks, monthly })
				)
				: sub === "models" ? react.createElement("div", { className: "dsh-pc-panel" },
				...
				: sub === "sessions" ? react.createElement("div", { className: "dsh-pc-panel" },
			...
			return react.createElement("div", { className: "dsh-pc-panel" },
				react.createElement("div", { className: "dsh-pc-tabs", role: "tablist" },
					TabButton("overview", t("subOverview"), sub, setSub),
					TabButton("activity", t("subActivity"), sub, setSub),
					TabButton("models", t("subModels"), sub, setSub),
					TabButton("sessions", t("subSessions"), sub, setSub),
					TabButton("cost", t("subCost"), sub, setSub)
				),
				block
			);
		}
