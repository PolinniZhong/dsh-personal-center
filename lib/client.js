...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function PetPanel({ t, petCtl }) {
			...
			// 皮肤选择(黑鲸 / 蓝鲸)
			const skinBtn = (id) => react.createElement("button", {
				className: "dsh-pc-pet-opacity-btn" + (curSkin === id ? " active" : ""),
				onClick: () => update({ skin: id })
			}, id === "black-whale" ? t("petSkinBlack") : t("petSkinBlue"));
				...
				react.createElement("div", { className: "dsh-pc-pet-card" },
					...
					react.createElement("div", { className: "dsh-pc-pet-info" },
						...
						react.createElement("div", { className: "dsh-pc-pet-sub" },
							react.createElement("span", { className: "dsh-pc-pet-sub-label" }, t("petSkin")),
							skinBtn("black-whale"),
							skinBtn("blue-whale")
						),
						react.createElement("div", { className: "dsh-pc-pet-sub" },
