...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			".dsh-pet-bubble{position:absolute;bottom:calc(100% + 12px);left:50%;transform:translateX(-50%) translateY(8px);background:rgba(255,255,255,.45);-webkit-backdrop-filter:blur(14px) saturate(1.5);backdrop-filter:blur(14px) saturate(1.5);color:var(--dsw-alias-label-primary);border:1px solid rgba(255,255,255,.55);padding:10px 16px;border-radius:16px;font-size:13px;white-space:nowrap;box-shadow:0 4px 20px rgba(0,0,0,.18);opacity:0;pointer-events:none;transition:opacity .25s ease,transform .25s ease;max-width:min(280px,60vw);overflow:hidden;text-overflow:ellipsis}" +
