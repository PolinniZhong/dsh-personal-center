...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			".dsh-pc-panel{min-width:0;padding-top:2px}" +
			/* 统计卡片 */
			...
			".dsh-pc-stat-value{color:var(--dsw-alias-label-primary);font-size:22px;font-weight:600;line-height:30px;font-variant-numeric:tabular-nums}" +
			".dsh-pc-stat-sub{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}" +
			/* 常用工具列表(无进度条,节省空间) */
			".dsh-pc-tools{display:flex;flex-direction:column;gap:8px}" +
			...
			".dsh-ci-textarea{box-sizing:border-box;width:100%;min-height:260px;margin-top:24px;resize:vertical;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l2);border-radius:12px;padding:12px 14px;font-family:inherit;font-size:14px;line-height:22px}" +
