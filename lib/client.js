...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			/* 注入预览(与上层输入框一致的描边;内部等宽文本区不再自描边) */
			".dsh-inst-preview{border:1px solid var(--dsw-alias-border-l2);border-radius:10px;padding:12px 14px;margin-top:16px;background:transparent}" +
			".dsh-inst-preview-title{font-size:11.5px;color:var(--dsw-alias-label-tertiary);margin-bottom:6px;display:flex;gap:8px;align-items:center;flex-wrap:wrap}" +
			...
			".dsh-inst-preview-box{font-size:11.5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;line-height:1.7;white-space:pre-wrap;color:var(--dsw-alias-label-secondary);max-height:110px;overflow-y:auto;margin-bottom:6px}" +
			".dsh-inst-preview-box .g{color:var(--dsw-alias-label-tertiary)}" +
			".dsh-inst-preview-box .w{color:var(--dsw-alias-state-business-primary)}" +
		...
		function PersonalizationTab({ t }) {
			...
			return react.createElement("div", { className: "dsh-pc-panel" },
				...
				// ── 模板库 ──
				react.createElement("div", { className: "dsh-inst-section", "data-active": sub === "tpl" },
						...
						templates.map((tpl) => {
							...
							return react.createElement("div", { key: tpl.id, className: "dsh-inst-tpl-row" },
								...
								react.createElement("div", { className: "dsh-inst-tpl-row-actions" },
									...
									btn("dsh-inst-btn dsh-inst-btn-primary", t("ciTplApplyGlobal"), () => onApplyTpl(tpl.text, "global")),
									btn("dsh-inst-btn", t("ciTplApplyWs"), () => onApplyTpl(tpl.text, "ws")),
				...
				react.createElement("div", { className: "dsh-inst-preview" },
					...
					react.createElement("div", { className: "dsh-inst-preview-box" },
						react.createElement("span", { className: "g" }, (draft ?? "") || ""),
						currentWsText && (draft || "").trim() !== "" && react.createElement("span", null, "\n\n"),
						currentWsText && react.createElement("span", { className: "w" }, currentWsText)
					),
