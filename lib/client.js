...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			/* 模板库 */
			".dsh-inst-tpl-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}" +
			".dsh-inst-tpl{border:1px solid var(--dsw-alias-border-l2);border-radius:12px;padding:12px 14px;display:flex;flex-direction:column;gap:6px}" +
			".dsh-inst-tpl:hover{border-color:var(--dsw-alias-state-business-primary)}" +
			".dsh-inst-tpl-head{display:flex;align-items:center;gap:6px}" +
			".dsh-inst-tpl-name{font-size:13px;font-weight:600;color:var(--dsw-alias-label-primary)}" +
			...
			".dsh-inst-tpl-desc{font-size:11.5px;color:var(--dsw-alias-label-tertiary);line-height:1.5;min-height:32px}" +
			...
			".dsh-inst-tpl-actions{display:flex;gap:6px;margin-top:2px;flex-wrap:wrap}" +
			...
			/* 注入预览 */
			".dsh-inst-preview{border-top:1px solid var(--dsw-alias-border-l2);padding:10px 0 0;margin-top:16px;background:var(--dsw-alias-bg-layer-3);border-radius:12px;padding:12px 14px}" +
			...
			".dsh-inst-preview-box{background:var(--dsw-alias-bg-module-platform);border:1px solid var(--dsw-alias-border-l2);border-radius:10px;padding:10px 12px;font-size:11.5px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;line-height:1.7;white-space:pre-wrap;color:var(--dsw-alias-label-secondary);max-height:110px;overflow-y:auto;margin-bottom:6px}" +
		...
		function PersonalizationTab({ t }) {
			...
			return react.createElement("div", { className: "dsh-pc-panel" },
				...
				react.createElement("div", { className: "dsh-inst-section", "data-active": sub === "tpl" },
					...
					react.createElement("div", { className: "dsh-inst-tpl-grid" },
						templates.map((tpl) => {
							const isBuiltin = String(tpl.id || "").startsWith("builtin-");
							const open = openTpls.has(tpl.id);
							return react.createElement("div", { key: tpl.id, className: "dsh-inst-tpl" },
								react.createElement("div", { className: "dsh-inst-tpl-head" },
									react.createElement("span", { className: "dsh-inst-tpl-name" }, tpl.name || "—"),
									!isBuiltin && react.createElement("span", { className: "dsh-inst-tpl-badge" }, t("ciTplCustom"))
								),
								react.createElement("div", { className: "dsh-inst-tpl-desc" }, tpl.desc || ""),
								react.createElement("div", { className: "dsh-inst-tpl-text", "data-open": open }, tpl.text || ""),
								react.createElement("div", { className: "dsh-inst-tpl-actions" },
