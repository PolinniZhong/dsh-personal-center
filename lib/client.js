	...
	factory: (require) => {
		...
		function ProfileTab({ t }) {
			...
			const block = sub === "overview" ? react.createElement("div", { className: "dsh-pc-panel" },
				...
				: sub === "cost" ? react.createElement("div", { className: "dsh-pc-panel" },
					react.createElement(CostEditor, { t })
				)
				: react.createElement("div", { className: "dsh-pc-panel" },
					react.createElement(PetEntry, { t })
				);
			...
			return react.createElement("div", { className: "dsh-pc-panel" },
				react.createElement("div", { className: "dsh-pc-pill-tabs", role: "tablist" },
					...
					PillTabButton("pet", t("subPet"), sub, setSub)
				),
				block
			);
		}
		...
		//#region desktop pet entry(占位入口,宠物本体另行设计)
		/**
		 * 桌面宠物入口:预览卡 + 未来配置项占位(开发中)。
		 * @param {{ t: (key: string) => string }} props
		 */
		function PetEntry({ t }) {
			return react.createElement("div", { className: "dsh-pc-panel" },
				react.createElement("div", { className: "dsh-pc-pet-card" },
					react.createElement("div", { className: "dsh-pc-pet-preview" }, "🐾"),
					react.createElement("div", { className: "dsh-pc-pet-info" },
						react.createElement("div", { className: "dsh-pc-activity-head" },
							...
							react.createElement("span", { className: "dsh-pc-pet-badge" }, t("petComing"))
						),
						react.createElement("p", { className: "dsh-pc-mock" }, t("petDesc"))
					)
				),
				react.createElement("div", { className: "dsh-pc-pet-opts" },
					react.createElement("div", { className: "dsh-pc-pet-opt" },
						react.createElement("span", { className: "dsh-pc-pet-opt-label" }, t("petEnable")),
						react.createElement("span", { className: "dsh-pc-pet-badge" }, t("petDev"))
					),
					react.createElement("div", { className: "dsh-pc-pet-opt" },
						react.createElement("span", { className: "dsh-pc-pet-opt-label" }, t("petSkin")),
						react.createElement("span", { className: "dsh-pc-pet-badge" }, t("petDev"))
					),
					react.createElement("div", { className: "dsh-pc-pet-opt" },
