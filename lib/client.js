...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = "" +
			...
			".dsh-ci-button{cursor:pointer;border:none;border-radius:8px;height:28px;padding:0 14px;font-size:13px;line-height:26px;font-family:inherit;display:inline-flex;align-items:center;justify-content:center}" +
